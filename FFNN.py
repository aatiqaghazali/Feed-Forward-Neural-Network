...
def Gradient_descent(xv,W1,W2,j,b,y_hat,a1,a2,Y,alpha,znorm1,znorm2,zhat1,zhat2):
 ...
 #b
    ...
    w1_11 =w1_11-(alpha * np.round(np.sum(dJ_by_dy_hat * dy_hat_by_da1 *  da1_by_z_hat1  *dz_hat1_by_dz_norm1 *  dz_norm1_by_dz1 *dz1_by_dw1_11 ),4))
    w1_12 = w1_12 -(alpha * np.round(np.sum(dJ_by_dy_hat * dy_hat_by_da1 *  da1_by_z_hat1  *dz_hat1_by_dz_norm1 *  dz_norm1_by_dz1 * dz1_by_dw1_12),4))
    w1_21 =w1_21-(alpha * np.round(np.sum(dJ_by_dy_hat * dy_hat_by_da2 *  da2_by_z_hat2 *dz_hat2_by_dz_norm2 *  dz_norm2_by_dz2 * dz2_by_dw2_21),4))
    w1_22 =w1_22-(alpha * np.round(np.sum(dJ_by_dy_hat * dy_hat_by_da2 *  da2_by_z_hat2 *dz_hat2_by_dz_norm2 *  dz_norm2_by_dz2 * dz2_by_dw2_22),4))
